...
ax.set_xlabel('t [s]')
plt.savefig('suckingInterface_plicRDF.pdf')
surfPos_plicRDF.to_csv("suckingInterface_plicRDF.csv", index=False)
...
ax.set_ylabel('x(t) [mm]')
ax.set_xlabel('t [s]')
plt.savefig('suckingInterface_isoSurface.pdf')
surfPos_isoSurface.to_csv("suckingInterface_isoSurface.csv", index=False)
plt.show()
