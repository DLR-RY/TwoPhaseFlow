...
Foam::tmp<Foam::volScalarField>
Foam::compressibleInterPhaseTransportModel::mut() const
{
    if (twoPhaseTransport_)
    {
        return
...
Foam::tmp<Foam::volScalarField>
Foam::compressibleInterPhaseTransportModel::alphat() const
{
    if (twoPhaseTransport_)
    {
        return
...
Foam::tmp<Foam::volScalarField>
Foam::compressibleInterPhaseTransportModel::muEff() const
{
    if (twoPhaseTransport_)
    {
        return
